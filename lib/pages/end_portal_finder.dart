...
class _EndPortalFinderState extends State<EndPortalFinder> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          TitledCard(
            title: Text("Location A", style: Theme.of(context).textTheme.title,),
            content: Column(
              children: <Widget>[
               MCRayForm(
                 ray: rayA,
          ...
          TitledCard(
            title: Text("Location B", style: Theme.of(context).textTheme.title,),
            content: Column(
              children: <Widget>[
               MCRayForm(
                 ray: rayB,
  ...
  void calculate() {
    if (widget._rayFormA.currentState.validate() && widget._rayFormB.currentState.validate()){
      widget._rayFormA.currentState.save();
      widget._rayFormB.currentState.save();

      Coordinate endPortal = rayA.interset(rayB);
      print(endPortal);
    }
  }
}